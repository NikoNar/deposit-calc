...
const TRANSLATIONS = {
  ...
  hy: {
    ...
    help_pmi: "Մասնավոր հիփոթեկային ապահովագրություն (PMI). Վարկատուները պահանջում են, երբ նախնական վճարը 20%-ից ցածր է: Պաշտպանում է վարկատուին: Սովորաբար կարող եք դադարեցնել, երբ LTV-ն հասնում է սահմանին (օր. 78%):",
    ...
    excel_title: "Հիփոթեկային ամորտիզացիա",
    faq_title: "Հաճախ տրվող հարցեր",
    faq_subtitle: "Հիփոթեկային հաշվիչ, ամորտիզացիա, PMI և վարկի համեմատություն:",
  },
};
